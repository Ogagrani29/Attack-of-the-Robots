...
background_image1 = pygame.image.load("../assets/BG_Grass.png")
background_image2 = pygame.image.load("../assets/BG_Sand.png")
background_image3 = pygame.image.load("../assets/BG_Urban.png")
background_image4 = pygame.image.load("../assets/BG_SciFi.png")
...
if hud.state == 'mainmenu':
    ishort = mixer.Sound('../assets/sfx/ishort.mp3')
    ishort.play()

#ilong
ilong = mixer.Sound('../assets/sfx/ilong.wav')
